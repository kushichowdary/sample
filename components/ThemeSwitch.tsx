...
const StyledWrapper = styled.div`
  ...
  /* Default styles for slider (dark/moon) */
  .slider {
    position: absolute;
    cursor: pointer;
    top: 0;
  ...
  /* Default styles for handle (moon) */
  .slider:before {
    position: absolute;
    content: "";
    height: 1.2em;
  ...
  /* Hide stars when checked (light) */
  .switch input:checked ~ .slider .star {
    opacity: 0;
  }

  /* Clouds hidden by default (dark) */
  .cloud {
    width: 3.5em;
    position: absolute;
    bottom: -1.4em;
  ...
  /* Show clouds when checked (light) */
